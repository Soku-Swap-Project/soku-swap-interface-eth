import DEFAULT_TOKEN_LIST from '../../eth_constants/token-lists/sushiswap-default.tokenlist.json'
import { ChainId, Token } from '@sushiswap/sdk'
import { Tags, TokenInfo, TokenList } from '@uniswap/token-lists'
import { useMemo } from 'react'
import { useSelector } from 'react-redux'
import sortByListPriority from 'utils/listSort'
import UNSUPPORTED_TOKEN_LIST from '../../eth_constants/token-lists/sushiswap-v2-unsupported.tokenlist.json'
import { AppState } from '../index'
import { UNSUPPORTED_LIST_URLS } from '../../eth_constants/lists'
