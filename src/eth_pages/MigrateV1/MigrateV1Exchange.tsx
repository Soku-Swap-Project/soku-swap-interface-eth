...
import { ButtonConfirmed } from '../../eth_components/ButtonLegacy'
import { LightCard, PinkCard, YellowCard } from '../../eth_components/Card'
import { AutoColumn } from '../../eth_components/Column'
import CurrencyLogo from '../../eth_components/CurrencyLogo'
import FormattedCurrencyAmount from '../../eth_components/FormattedCurrencyAmount'
import QuestionHelper from '../../eth_components/QuestionHelper'
import { AutoRow, RowBetween, RowFixed } from '../../eth_components/Row'
import { Dots } from '../../eth_components/swap/styleds'
import { DEFAULT_DEADLINE_FROM_NOW, INITIAL_ALLOWED_SLIPPAGE } from '../../eth_constants'
import { MIGRATOR_ADDRESS } from '../../eth_constants/abis/migrator'
...
import { useToken } from '../../eth_hooks/Tokens'
import { ApprovalState, useApproveCallback } from '../../eth_hooks/useApproveCallback'
import { useV1ExchangeContract, useV2MigratorContract } from '../../eth_hooks/useContract'
import { NEVER_RELOAD, useSingleCallResult } from '../../eth_state/multicall/hooks'
import { useIsTransactionPending, useTransactionAdder } from '../../eth_state/transactions/hooks'
import { useETHBalances, useTokenBalance } from '../../eth_state/wallet/hooks'
