...
import { AutoRow } from '../../eth_components/Row'
import { DEFAULT_DEADLINE_FROM_NOW } from '../../eth_constants'
import { useActiveWeb3React } from '../../eth_hooks'
import { useToken } from '../../eth_hooks/Tokens'
import { useV1ExchangeContract } from '../../eth_hooks/useContract'
...
import { useTokenBalance, useETHBalances } from '../../eth_state/wallet/hooks'
