...
import DoubleCurrencyLogo from '../../eth_components/DoubleLogo'
import { AddRemoveTabs } from '../../eth_components/NavigationTabs'
import { MinimalPositionCard } from '../../eth_components/PositionCard'
import Row, { RowBetween, RowFixed } from '../../eth_components/Row'
import Slider from '../../eth_components/Slider'
import { Dots } from '../../eth_components/swap/styleds'
import TransactionConfirmationModal, {
    ConfirmationModalContent
} from '../../eth_components/TransactionConfirmationModal'
import { useActiveWeb3React } from '../../eth_hooks'
import { useCurrency } from '../../eth_hooks/Tokens'
import { ApprovalState, useApproveCallback } from '../../eth_hooks/useApproveCallback'
import { usePairContract } from '../../eth_hooks/useContract'
import useIsArgentWallet from '../../eth_hooks/useIsArgentWallet'
import useTransactionDeadline from '../../eth_hooks/useTransactionDeadline'
import { useWalletModalToggle } from '../../eth_state/application/hooks'
import { Field } from '../../eth_state/burn/actions'
import { useBurnActionHandlers, useBurnState, useDerivedBurnInfo } from '../../eth_state/burn/hooks'
        ...
        return (
            <AutoColumn gap={'md'} style={{ marginTop: '20px' }}>
                <RowBetween align="flex-end">
                    <Text color={'#05195a'} fontSize={24} fontWeight={500}>
                        {parsedAmounts[Field.CURRENCY_A]?.toSignificant(6)}
                    </Text>
                    <RowFixed gap="4px">
                        <CurrencyLogo currency={currencyA} size={'24px'} />
                        <Text color={'#05195a'} fontSize={24} fontWeight={500} style={{ marginLeft: '10px' }}>
                            {currencyA?.getSymbol(chainId)}
                        </Text>
                    </RowFixed>
                </RowBetween>
                            ...
                            >
                                <AutoColumn>
                                    ...
                                    <Row style={{ alignItems: 'flex-end' }}>
                                        <Text
                                            className="remove_liquidity_percentage"
                                            fontSize={64}
                                            fontWeight={500}
                                            color="#05195a"
                                        >
