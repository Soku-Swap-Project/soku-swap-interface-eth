...
import { useSushiRollContract } from 'eth_hooks/useContract'
import React, { useCallback, useContext, useEffect, useState } from 'react'
import { ChevronRight } from 'react-feather'
import { Text } from 'rebass'
import styled, { ThemeContext } from 'styled-components'
import Circle from '../../eth_assets/images/blue-loader.svg'
import { ButtonConfirmed } from '../../eth_components/ButtonLegacy'
import { LightCard } from '../../eth_components/Card'
...
import { FixedHeightRow } from '../../eth_components/PositionCard'
import QuestionHelper from '../../eth_components/QuestionHelper'
import { AutoRow, RowFixed } from '../../eth_components/Row'
...
import useMigrateState, { MigrateState } from '../../eth_hooks/useMigrateState'
        ...
        <>
            ...
            {items.reduce((acc: any, { key, text, description }: any) => {
                if (state.mode === undefined || key === state.mode)
                    acc.push(
                        <div className="wallet_type_card">
                            <LightCard key={key}>
                                <AutoColumn gap="12px" className="wallet_type_options">
                                    <RowFixed>
            ...
            <AppBody style={{ padding: 24 }}>
                <AutoColumn gap="16px">
                    <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
                        ...
                        <div>
                            <QuestionHelper text="Migrate your Uniswap LP tokens to SokuSwap LP tokens." />
                        </div>
                    </AutoRow>
