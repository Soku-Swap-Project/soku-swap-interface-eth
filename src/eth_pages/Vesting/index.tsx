...
import Fraction from '../../eth_entities/Fraction'
import { useActiveWeb3React } from '../../eth_hooks'
import { ApplicationModal } from '../../eth_state/application/actions'
import { useModalOpen, useToggleSelfClaimModal } from '../../eth_state/application/hooks'
import { useClaimCallback, useUserUnclaimedAmount } from '../../eth_state/claim/hooks'
import { useUserHasSubmittedClaim } from '../../eth_state/transactions/hooks'
