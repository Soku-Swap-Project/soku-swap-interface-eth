...
import { ButtonEmpty, ButtonPrimary } from '../../eth_components/ButtonLegacy'
import { AutoColumn } from '../../eth_components/Column'
import DoubleCurrencyLogo from '../../eth_components/DoubleLogo'
import ClaimRewardModal from '../../eth_components/earn/ClaimRewardModal'
import StakingModal from '../../eth_components/earn/StakingModal'
import { CardBGImage, CardNoise, CardSection, DataCard } from '../../eth_components/earn/styled'
import UnstakingModal from '../../eth_components/earn/UnstakingModal'
import { RowBetween } from '../../eth_components/Row'
import { BIG_INT_SECONDS_IN_WEEK, BIG_INT_ZERO } from '../../eth_constants'
...
import usePrevious from '../../eth_hooks/usePrevious'
...
export default function Manage({
    ...
    if (totalSupplyOfStakingToken && stakingTokenPair && stakingInfo && WETH) {
        ...
        valueOfTotalStakedAmountInWETH = new TokenAmount(
            ...
            JSBI.divide(
                JSBI.multiply(
                    JSBI.multiply(stakingInfo.totalStakedAmount.raw, stakingTokenPair.reserveOf(WETH as any).raw),
