...
import Logo from '../../eth_assets/images/logo.png'
import { useActiveWeb3React } from '../../eth_hooks'
import { useETHBalances } from '../../eth_state/wallet/hooks'
import { ReactComponent as Burger } from '../../eth_assets/images/burger.svg'
import { ReactComponent as X } from '../../eth_assets/images/x.svg'
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="hidden sm:block sm:ml-4">
                                    <div className="flex space-x-2">
                                        <NavLink id={`swap-nav-link`} to={'/swap/eth'}>
                                            {t('swap')}
                                        </NavLink>
                                        <NavLink
                                            id={`pool-nav-link`}
                                            ...
                                            isActive={(match, { pathname }) =>
                                                Boolean(match) ||
                                                pathname.startsWith('/add/eth') ||
                                                pathname.startsWith('/remove/eth') ||
                                                pathname.startsWith('/create/eth') ||
                                                pathname.startsWith('/find/eth')
                                            }
                                        >
                                            {t('pool')}
                                        </NavLink>
