...
import { classNames } from '../../eth_functions/styling'
import { ExternalLink } from '../Link'
import { ReactComponent as MenuIcon } from '../../eth_assets/images/menu.svg'
const solutions = [
    {
        name: 'Docs',
                    ...
                    >
                        ...
                        >
                            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                <div className="relative grid gap-6 bg-red px-5 py-6 sm:gap-8 sm:p-8">
                                    {solutions.map(item => (
                                        <ExternalLink
                                            key={item.name}
                                            href={item.href}
                                            className="-m-3 p-3 block rounded-md hover:bg-red transition ease-in-out duration-150"
                                        >
