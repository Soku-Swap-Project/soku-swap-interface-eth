...
import { fortmatic, injected, lattice, portis, torus, walletconnect, walletlink } from '../eth_connectors'
...
export const SUSHI: ChainTokenMap = {
    ...
    [ChainId.GÖRLI]: new Token(ChainId.GÖRLI, '0x287e57bc655c7b019e4ce5f225f5a6832fef99ae', 18, 'SOKU', 'Soku Token'),
    [ChainId.KOVAN]: new Token(ChainId.KOVAN, '0x287e57bc655c7b019e4ce5f225f5a6832fef99ae', 18, 'SOKU', 'Soku Token')
