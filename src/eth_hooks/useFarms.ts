...
import { useBoringHelperContract } from 'eth_hooks/useContract'
import _ from 'lodash'
import { useCallback, useEffect, useState } from 'react'
import { exchange, masterchef } from 'eth_apollo/client'
import { getAverageBlockTime } from 'eth_apollo/getAverageBlockTime'
import { liquidityPositionSubsetQuery, pairSubsetQuery, poolsQuery } from 'eth_apollo/queries'
import { POOL_DENY } from '../eth_constants'
...
const useFarms = () => {
    ...
    const fetchAllFarms = useCallback(async () => {
        ...
        if (account) {
            ...
            // const userFarms = farms.map((farm: any) => {
